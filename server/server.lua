...
RegisterNetEvent("kael-cigar:server:PickUpTobacco", function()
...
QBCore.Functions.CreateCallback("kael-cigar:server:makingcigar", function(source, cb, item)
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent("kael-cigar:server:GiveCigar", function(item)
    local Player = QBCore.Functions.GetPlayer(source)
